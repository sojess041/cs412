...
SECRET_KEY = 'django-insecure-+!ns$jcqta4s8fa7u0@zoukq7=(l75rhmvd(056sp03s-&djer'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'cs412/quotes/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "cs412/quotes/static"),
]
